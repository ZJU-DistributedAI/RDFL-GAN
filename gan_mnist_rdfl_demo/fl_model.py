...
import rdfl.core.strategy as strategy
...
if __name__ == "__main__":
    ...
    job = job_manager.generate_job(work_mode=strategy.WorkModeStrategy.WORKMODE_STANDALONE,
                                   fed_strategy=strategy.FederateStrategy.FED_DISTILLATION, epoch=200, g_model=GNet, d_model=DNet, distillation_alpha=0.5)
